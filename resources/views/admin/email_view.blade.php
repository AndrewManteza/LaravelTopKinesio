        ...
        <div class="container" align ="center" style="padding-top: 100px">
          ...
          <form action="{{url('sendemail',$data->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div style="padding:15px">
              ...
              <input type="text" style="color:black" name="Greet" placeholder="Greet" required="">
            ...
            <div style="padding:15px">
              ...
              <label>Body</label>
              <input type="text" style="color:black" name="Body" placeholder="Body" required="">
            ...
            <div style="padding:15px">
                ...
                <label>End</label>
                <input type="text" style="color:black" name="End<" placeholder="End<" required="">

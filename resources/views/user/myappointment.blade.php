  ...
  <div align = "center" style="padding:70px;">
    <table>
      <tr style = "background-color:black;">
        <th style="padding:10px; font-size: 20px; color:white;">Therapist Name</th>
      ...
      <tr style = "background-color:black;"  align = "center">
        <td style="padding:10px; color:white;;" >{{$appoints->therapist}}</td>
        ...
        <td><a class="bt btn-danger" onclick="return confirm('confirm deletion?')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
